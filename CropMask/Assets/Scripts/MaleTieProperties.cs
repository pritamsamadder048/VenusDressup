...
[Serializable]
public class MaleTieProperties : MonoBehaviour , ISerializationCallbackReceiver
{
    [NonSerialized]
    public MiniJsonObject mo;

    public string propertyType = "maletie";
    ...
    public float[] tieColor = new float[] { 0.5f, 0.5f, 0.5f, 1f };
    ...
    public void Clone(MaleTieProperties fwp)
    {
        this.tieColor = new float[] { fwp.tieColor[0], fwp.tieColor[1], fwp.tieColor[2], fwp.tieColor[3] };
    ...
    public void InitializeTieProperty(MiniJsonObject m)
    {
        ...
        print("initializing male tie property");
        propertyType = "maletie";
        GetComponent<Button>().onClick.RemoveAllListeners();
        GetComponent<Button>().onClick.AddListener(InvokeUseThisTie);
        ...
        tieColor = new float[] { 0.5f, 0.5f, 0.5f, 1f };
        _isInitialized = true;
        StartCoroutine(SetImage());
    }


    public void InitializeTieProperty(MiniJsonObject m , Color wc)
    {
        if (gameController == null)
        {
            gameController = GameObject.FindGameObjectWithTag("GameController").GetComponent<GameController>();
        ...
        tieColor = new float[] { wc.r, wc.g, wc.b, wc.a };
    ...
    public void InitializeTieProperty( string jsonString)
    {
        ...
        tieColor = new float[] { 0.5f, 0.5f, 0.5f, 1f };
        _isInitialized = true;
        print("successfully init male wig property");
        //StartCoroutine(SetImage());
    }


    public void InitializeTieProperty(string jsonString ,Color wc)
    {
        if (jsonString == "" || jsonString == null)
        {
            IsInitialized = false;
    ...
    public void SetMaleTieColor(Color col)
    {
        tieColor = new float[] { col.r, col.g, col.b, col.a };
    }
    public void SetMaleTieColor(float[] col)
    {
        tieColor = new float[] { col[0], col[1], col[2], col[3] };
    }

    public void InvokeUseThisTie()
    {
        if(gameController!=null)
        {
    ...
    public IEnumerator SetImage()
    {
        ...
        if (IsInitialized)
        {
            ...
            if (File.Exists(finalSavePath) && File.Exists(thumbnailpath))
            {
                ...
                gameController.maleController.maleTieLoadingPanel.SetActive(false);
