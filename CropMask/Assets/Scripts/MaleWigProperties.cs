...
[Serializable]
public class MaleWigProperties : MonoBehaviour , ISerializationCallbackReceiver
{
    [NonSerialized]
    public MiniJsonObject mo;

    public string propertyType = "malewig";
    ...
    public void SetMaleWigColor(Color col)
    {
        wigColor = new float[] { col.r, col.g, col.b, col.a };
    }
    public void SetMaleWigColor(float[] col)
    {
    ...
    public void UseThisWig()
    {
        if (_isInitialized)
        {
            ...
            gameController.maleController.PutOnMaleWigDynamically(this);
    ...
    public IEnumerator SetImage()
    {
        ...
        if (IsInitialized)
        {
            ...
            if (File.Exists(finalSavePath) && File.Exists(thumbnailpath))
            {
                ...
                gameController.maleController.maleWigLoadingPanel.SetActive(false);
