...
public class MaleUIImageColorPicker : MonoBehaviour
{
    ...
    public bool tiecolor = false;
    public bool tiebrightness = false;
    ...
    public void ActivateColorSlider(bool resetSlider = true)
    {
        if (resetSlider)
        {
            if (wigbrightness || tiebrightness)
            {
